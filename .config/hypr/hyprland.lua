...
hl.config({
    exec_once = {
        "dbus-update-activation-environment --systemd WAYLAND_DISPLAY XDG_CURRENT_DESKTOP QT_QPA_PLATFORMTHEME", -- Replace with the exact binary execution command of the script or app
    }
})
...
---- MONITORS ----
------------------
hl.bind("SUPER + SHIFT + M", hl.dsp.exec_cmd("hyprctl dispatch dpms off"))
...
hl.config({
    -- ... your other existing settings (general, input, etc.) ...
